...
// TestConnector_usingSDKTester runs the Fivetran SDK tester against the connector.
//
// PREREQUISITES:
...
//
// The test:
//  1. Starts the connector server on port 50052 (accessible from Docker via host.docker.internal)
...
func TestConnector_usingSDKTester(t *testing.T) {
