...
const (
	...
	DestinationConnector_Migrate_FullMethodName           = "/fivetran_sdk.v2.DestinationConnector/Migrate"
)
...
func (c *destinationConnectorClient) Migrate(ctx context.Context, in *MigrateRequest, opts ...grpc.CallOption) (*MigrateResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(MigrateResponse)
	err := c.cc.Invoke(ctx, DestinationConnector_Migrate_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedDestinationConnectorServer) Migrate(context.Context, *MigrateRequest) (*MigrateResponse, error) {
...
func _DestinationConnector_Migrate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DestinationConnector_Migrate_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var DestinationConnector_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "Migrate",
			Handler:    _DestinationConnector_Migrate_Handler,
		},
	},
